...
class Buffer:
    ...
    def export_01_turn(self, device=None, length=None, out=None, sep_token=102):
        if out is None:
            if length is None:
                total_length = self.calc_size()
                if total_length > CAPACITY:
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        ids[-1] = torch.tensor([sep_token], dtype=torch.long, device=device)
